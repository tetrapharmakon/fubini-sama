...
\end{remark}
\begin{theorem}[a few isomorphisms of the calculus]\label{a-few-isos} We collect
...
The category $\elts{C }{W}$ defined in \refbf{eltsf} can be equivalently
...
The latter object, that uniquely determines the object $\lim_J F$, can be
rewritten as
\[
\Nat(*, \hom(F,a))
\]
